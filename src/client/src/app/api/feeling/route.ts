...
import { EXCHANGE_NAME, EXCHANGE_TYPE, QUEUE, ROUTING_KEY_FEELING } from '@/constants/env';
...
export async function POST(req: Request) {
    try {
        ...
        channel.publish(EXCHANGE_NAME, ROUTING_KEY_FEELING, Buffer.from(buffer));

        console.log(`Imagem publicada na fila 'team_queue' com ROUTING_KEY_FEELING: ${ROUTING_KEY_FEELING}`);
        await channel.close();
